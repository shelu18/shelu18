...
### 🧩 Core React Native skill set

**React Native ecosystem**

- React Native, **Expo**
- **TypeScript**, JavaScript (ES6+)
- React Navigation (stack, tab, nested navigators)
- Zustand (global state, auth, lead/call state)
- AsyncStorage (secure-ish persistence, session handling)
- Axios (REST API integration)

**Mobile capabilities**

- Push notifications with **Firebase Cloud Messaging (FCM)**
- Real-time features: chat, live updates (Socket.IO)
- Google Maps & location (maps, markers, permissions, reverse geocoding)
- Auth flows:
  - **Google Sign-In / OAuth 2.0**
  - JWT-based auth (access/refresh tokens, token refresh on API calls)
- Auto-dial workflows (passing numbers to the native dialer)
...
- Git, GitHub, Postman
- Docker, basic AWS
- Vue.js + Vuetify (for admin dashboards & internal tools)
